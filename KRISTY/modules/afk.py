...
from KRISTY.modules.disable import (
    DisableAbleCommandHandler,
    DisableAbleMessageHandler,
)
from KRISTY.modules.sql import afk_sql as sql
from KRISTY.modules.users import get_user_id
...
def afk(update: Update, context: CallbackContext):
    ...
    if len(args) >= 2:
        ...
        if len(reason) > 150:
            reason = reason[:150]
            notice = "\nʏᴏᴜʀ ᴀꜰᴋ ʀᴇᴀꜱᴏɴ ᴡᴀꜱ ꜱʜᴏʀᴛᴇɴᴇᴅ ᴛᴏ 150 ᴄʜᴀʀᴀᴄᴛᴇʀꜱ 🖤."
    else:
        reason = ""
    ...
    if message.entities and message.parse_entities(
        ...
        for ent in entities:
            ...
            try:
                ...
                print("ᴇʀʀᴏʀ: ᴄᴏᴜʟᴅ ɴᴏᴛ ꜰᴇᴛᴄʜ ᴜꜱᴇʀɪᴅ {} ꜰᴏʀ ᴀꜰᴋ ᴍᴏᴅᴜʟᴇ 🖤".format(user_id))
                return
