...
import requests
from KRISTY import TIME_API_KEY, dispatcher
...
def gettime(update: Update, context: CallbackContext):
    ...
    try:
        ...
        message.reply_text("ᴘʀᴏᴠɪᴅᴇ ᴀ ᴄᴏᴜɴᴛʀʏ ɴᴀᴍᴇ/ᴀʙʙʀᴇᴠɪᴀᴛɪᴏɴ/ᴛɪᴍᴇᴢᴏɴᴇ ᴛᴏ ꜰɪɴᴅ ʙᴀʙʏ🖤.")
        return
    send_message = message.reply_text(
        f"ꜰɪɴᴅɪɴɢ ᴛɪᴍᴇᴢᴏɴᴇ ɪɴꜰᴏ ꜰᴏʀ <b>{query}</b> ʙᴀʙʏ🖤",
    ...
    if not result:
        send_message.edit_text(
            f"ᴛɪᴍᴇᴢᴏɴᴇ ɪɴꜰᴏ ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ꜰᴏʀ <b>{query}</b> ʙᴀʙʏ🖤\n"
