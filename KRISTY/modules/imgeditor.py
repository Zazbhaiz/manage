...
from KRISTY.ex_plugins.ImageEditor.edit_1 import (  # pylint:disable=import-error
    black_white,
    box_blur,
    bright,
    g_blur,
...
from KRISTY.ex_plugins.ImageEditor.edit_2 import (  # pylint:disable=import-error
    cartoon,
    circle_with_bg,
    circle_without_bg,
    contrast,
...
from KRISTY.ex_plugins.ImageEditor.edit_3 import (  # pylint:disable=import-error
    black_border,
    blue_border,
    green_border,
    red_border,
)
from KRISTY.ex_plugins.ImageEditor.edit_4 import (  # pylint:disable=import-error
    inverted,
    removebg_plain,
    removebg_sticker,
    removebg_white,
...
from KRISTY.ex_plugins.ImageEditor.edit_5 import (  # pylint:disable=import-error
    normalglitch_1,
    normalglitch_2,
    normalglitch_3,
    normalglitch_4,
...
async def photo(client: pbot, message: Message):
    try:
        if not message.reply_to_message.photo:
            await client.send_message(message.chat.id, "ʀᴇᴘʟʏ ᴛᴏ ᴀɴ ɪᴍᴀɢᴇ ʙᴀʙʏ🖤!")
            return
    except:
        return
    global lel
    ...
    try:
        await client.send_message(
            ...
            text="ꜱᴇʟᴇᴄᴛ ʏᴏᴜʀ ʀᴇQᴜɪʀᴇᴅ ᴍᴏᴅᴇ ꜰʀᴏᴍ ʙᴇʟᴏᴡ ʙᴀʙʏ🖤!",
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text="ᴄʟᴏꜱᴇ", callback_data="close_e"),
                    ],
                ]
            ),
        ...
        if "USER_IS_BLOCKED" in str(e):
            ...
            try:
                await message.reply_text("ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ ʙᴀʙʏ🖤!", quote=True)
            except Exception:
                return
    ...
    if lel == user_id:
        if query.data == "removebg":
            await query.message.edit_text(
                "**ꜱᴇʟᴇᴄᴛ ʀᴇQᴜɪʀᴇᴅ ᴍᴏᴅᴇ ʙᴀʙʏ🖤**ㅤㅤㅤㅤ",
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
            ...
            await query.message.edit_text(
                "**ꜱᴇʟᴇᴄᴛ ɢʟɪᴛᴄʜ ᴘᴏᴡᴇʀ ʟᴇᴠᴇʟ ʙᴀʙʏ🖤**",
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
