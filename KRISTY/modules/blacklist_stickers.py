...
import KRISTY.modules.sql.blsticker_sql as sql
...
def blackliststicker(update: Update, context: CallbackContext):
    ...
    for text in split_text:
        if (
            sticker_list
            == "<b>ʟɪꜱᴛ ʙʟᴀᴄᴋʟɪꜱᴛᴇᴅ ꜱᴛɪᴄᴋᴇʀꜱ ᴄᴜʀʀᴇɴᴛʟʏ ɪɴ {}:</b>\n".format(
                chat_name,
    ...
    if len(words) > 1:
        ...
        for trigger in to_blacklist:
            try:
                ...
                send_message(
                    update.effective_message,
                    "ꜱᴛɪᴄᴋᴇʀ `{}` ᴄᴀɴ ɴᴏᴛ ʙᴇ ꜰᴏᴜɴᴅ ʙᴀʙʏ🖤!".format(trigger),
                    parse_mode="markdown",
                )
        ...
        if len(to_blacklist) == 1:
            send_message(
                update.effective_message,
                "ꜱᴛɪᴄᴋᴇʀ <code>{}</code> ᴀᴅᴅᴇᴅ ᴛᴏ ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀꜱ ɪɴ <b>{}</b> ʙᴀʙʏ🖤!".format(
            ...
            send_message(
                update.effective_message,
                "<code>{}</code> ꜱᴛɪᴄᴋᴇʀꜱ ᴀᴅᴅᴇᴅ ᴛᴏ ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀ ɪɴ <b>{}</b> ʙᴀʙʏ🖤!".format(
                    added,
                    html.escape(chat_name),
                ),
                parse_mode=ParseMode.HTML,
        ...
        if trigger is None:
            send_message(update.effective_message, "ꜱᴛɪᴄᴋᴇʀ ɪꜱ ɪɴᴠᴀʟɪᴅ ʙᴀʙʏ🖤!")
            return
        try:
            get = bot.getStickerSet(trigger)
            sql.add_to_stickers(chat_id, trigger.lower())
        ...
        send_message(
            update.effective_message,
            "ᴛᴇʟʟ ᴍᴇ ᴡʜᴀᴛ ꜱᴛɪᴄᴋᴇʀꜱ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴀᴅᴅ ᴛᴏ ᴛʜᴇ ʙʟᴀᴄᴋʟɪꜱᴛ ʙᴀʙʏ🖤.",
        )
    ...
    if len(words) > 1:
        ...
        if len(to_unblacklist) == 1:
            if successful:
                send_message(
                    update.effective_message,
                    "ꜱᴛɪᴄᴋᴇʀꜱ <code>{}</code> ᴅᴇʟᴇᴛᴇᴅ ꜰʀᴏᴍ ʙʟᴀᴄᴋʟɪꜱᴛ ɪɴ <b>{}</b> ʙᴀʙʏ🖤!".format(
                ...
                send_message(
                    update.effective_message,
                    "ᴛʜɪꜱ ꜱᴛɪᴄᴋᴇʀ ɪꜱ ɴᴏᴛ ᴏɴ ᴛʜᴇ ʙʟᴀᴄᴋʟɪꜱᴛ ʙᴀʙʏ🖤...!",
                )
            ...
            send_message(
                update.effective_message,
                "ɴᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ ꜱᴛɪᴄᴋᴇʀꜱ ᴇxɪꜱᴛ, ꜱᴏ ᴛʜᴇʏ ᴄᴀɴɴᴏᴛ ʙᴇ ʀᴇᴍᴏᴠᴇᴅ ʙᴀʙʏ🖤.",
                parse_mode=ParseMode.HTML,
            )
            ...
            send_message(
                update.effective_message,
                "ꜱᴛɪᴄᴋᴇʀꜱ <code>{}</code> ᴅᴇʟᴇᴛᴇᴅ ꜰʀᴏᴍ ʙʟᴀᴄᴋʟɪꜱᴛ. {} ᴅɪᴅ ɴᴏᴛ ᴇxɪꜱᴛ, ꜱᴏ ɪᴛ'ꜱ ɴᴏᴛ ᴅᴇʟᴇᴛᴇᴅ ʙᴀʙʏ🖤.".format(
                    successful,
        ...
        if success:
            ...
            send_message(
                update.effective_message,
                "{} ɴᴏᴛ ꜰᴏᴜɴᴅ ᴏɴ ʙʟᴀᴄᴋʟɪꜱᴛᴇᴅ ꜱᴛɪᴄᴋᴇʀꜱ ʙᴀʙʏ🖤...!".format(trigger),
            )
    else:
        send_message(
            update.effective_message,
...
def blacklist_mode(update: Update, context: CallbackContext):
    ...
    if conn:
        ...
        if update.effective_message.chat.type == "private":
            send_message(
                update.effective_message,
                "ʏᴏᴜ ᴄᴀɴ ᴅᴏ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪɴ ɢʀᴏᴜᴘꜱ, ɴᴏᴛ ᴘᴍ ʙᴀʙʏ🖤",
            )
            return ""
    ...
    if args:
        if args[0].lower() in ["off", "nothing", "no"]:
            ...
            return
        if conn:
            text = "ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀ ᴍᴏᴅᴇ ᴄʜᴀɴɢᴇᴅ, ᴜꜱᴇʀꜱ ᴡɪʟʟ ʙᴇ `{}` ᴀᴛ *{}* ʙᴀʙʏ🖤!".format(
                settypeblacklist,
                chat_name,
            )
        else:
            text = "ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀ ᴍᴏᴅᴇ ᴄʜᴀɴɢᴇᴅ, ᴜꜱᴇʀꜱ ᴡɪʟʟ ʙᴇ `{}` ʙᴀʙʏ🖤!".format(
                settypeblacklist,
            )
        ...
        return (
            "<b>{}:</b>\n"
            "<b>ᴀᴅᴍɪɴ:</b> {}\n"
            "ᴄʜᴀɴɢᴇᴅ ꜱᴛɪᴄᴋᴇʀ ʙʟᴀᴄᴋʟɪꜱᴛ ᴍᴏᴅᴇ. ᴜꜱᴇʀꜱ ᴡɪʟʟ ʙᴇ {} ʙᴀʙʏ🖤.".format(
    ...
    if getmode == 0:
        ...
        settypeblacklist = "ᴛᴇᴍᴘᴏʀᴀʀɪʟʏ ʙᴀɴɴᴇᴅ ꜰᴏʀ {}".format(getvalue)
    elif getmode == 7:
        settypeblacklist = "ᴛᴇᴍᴘᴏʀᴀʀɪʟʏ ᴍᴜᴛᴇᴅ ꜰᴏʀ {}".format(getvalue)
    if conn:
        text = "ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀ ᴍᴏᴅᴇ ɪꜱ ᴄᴜʀʀᴇɴᴛʟʏ ꜱᴇᴛ ᴛᴏ *{}* ɪɴ *{}* ʙᴀʙʏ🖤.".format(
            settypeblacklist,
            chat_name,
        )
    else:
        text = "ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀ ᴍᴏᴅᴇ ɪꜱ ᴄᴜʀʀᴇɴᴛʟʏ ꜱᴇᴛ ᴛᴏ *{}* ʙᴀʙʏ🖤.".format(
            settypeblacklist,
        )
            ...
            try:
                ...
                if getmode == 1:
                    ...
                    warn(
                        ...
                        chat,
                        "ᴜꜱɪɴɢ ꜱᴛɪᴄᴋᴇʀ '{}' ᴡʜɪᴄʜ ɪɴ ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀꜱ ʙᴀʙʏ🖤".format(
                            trigger,
                        ),
                        message,
                        update.effective_user,
                    ...
                    bot.sendMessage(
                        chat.id,
                        "{} ᴍᴜᴛᴇᴅ ʙᴇᴄᴀᴜꜱᴇ ᴜꜱɪɴɢ '{}' ᴡʜɪᴄʜ ɪɴ ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀꜱ ʙᴀʙʏ🖤".format(
                    ...
                    if res:
                        bot.sendMessage(
                            chat.id,
                            "{} ᴋɪᴄᴋᴇᴅ ʙᴇᴄᴀᴜꜱᴇ ᴜꜱɪɴɢ '{}' ᴡʜɪᴄʜ ɪɴ ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀꜱ ʙᴀʙʏ🖤".format(
                                mention_markdown(user.id, user.first_name),
                                trigger,
                            ),
                            parse_mode="markdown",
                    ...
                    bot.sendMessage(
                        chat.id,
                        "{} ʙᴀɴɴᴇᴅ ʙᴇᴄᴀᴜꜱᴇ ᴜꜱɪɴɢ '{}' ᴡʜɪᴄʜ ɪɴ ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀꜱ ʙᴀʙʏ🖤".format(
                            mention_markdown(user.id, user.first_name),
                            trigger,
                        ),
                        parse_mode="markdown",
                    ...
                    bot.sendMessage(
                        chat.id,
                        "{} ʙᴀɴɴᴇᴅ ꜰᴏʀ {} ʙᴇᴄᴀᴜꜱᴇ ᴜꜱɪɴɢ '{}' ᴡʜɪᴄʜ ɪɴ ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀꜱ ʙᴀʙʏ🖤".format(
                            mention_markdown(user.id, user.first_name),
                            value,
                            trigger,
                        ),
                    ...
                    bot.sendMessage(
                        chat.id,
                        "{} ᴍᴜᴛᴇᴅ ꜰᴏʀ {} ʙᴇᴄᴀᴜꜱᴇ ᴜꜱɪɴɢ '{}' ᴡʜɪᴄʜ ɪɴ ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀꜱ ʙᴀʙʏ🖤".format(
                            mention_markdown(user.id, user.first_name),
                            value,
                            trigger,
                        ),
...
def __chat_settings__(chat_id, user_id):
    ...
    return "ᴛʜᴇʀᴇ ᴀʀᴇ `{} `ʙʟᴀᴄᴋʟɪꜱᴛᴇᴅ ꜱᴛɪᴄᴋᴇʀꜱ ʙᴀʙʏ🖤.".format(blacklisted)


def __stats__():
    return "× {} ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀꜱ, ᴀᴄʀᴏꜱꜱ {} ᴄʜᴀᴛꜱ ʙᴀʙʏ🖤.".format(
