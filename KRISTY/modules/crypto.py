from KRISTY.utils.sections import section
import requests
...
def crypto(update: Update, context: CallbackContext):
    ...
    try:
        ...
        return message.reply_text("[ᴇʀʀᴏʀ]: ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ ʙᴀʙʏ🖤.")

    if currency not in result:
        return update.effective_message.reply_text(
            "[ᴇʀʀᴏʀ]: ɪɴᴠᴀʟɪᴅ ᴄᴜʀʀᴇɴᴄʏ ʙᴀʙʏ🖤",
...
__mod_name__ = "Crypto"
__help__ = """
   ➢ `/crypto` [currency] :ɢᴇᴛ ʀᴇᴀʟ ᴛɪᴍᴇ ᴠᴀʟᴜᴇ ꜰʀᴏᴍ ᴄᴜʀʀᴇɴᴄʏ ɢɪᴠᴇɴ.
"""
