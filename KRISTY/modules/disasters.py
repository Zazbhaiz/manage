...
» `/dragons`*:*ʟɪꜱᴛꜱ ᴀʟʟ ᴅᴇᴍᴏɴ ᴅɪꜱᴀꜱᴛᴇʀꜱ
 ...
 ╔ *Speedtest:*
 ╚ `/speedtest`*:* ʀᴜɴꜱ ᴀ ꜱᴘᴇᴇᴅᴛᴇꜱᴛ ᴀɴᴅ ɢɪᴠᴇꜱ ʏᴏᴜ 2 ᴏᴘᴛɪᴏɴꜱ ᴛᴏ ᴄʜᴏᴏꜱᴇ ꜰʀᴏᴍ, ᴛᴇxᴛ ᴏʀ ɪᴍᴀɢᴇ ᴏᴜᴛᴘᴜᴛ
 ╔ *Global Bans:*
 » `/gban user reason`*:* ɢʟᴏʙᴀʟʟʏ ʙᴀɴꜱ ᴀ ᴜꜱᴇʀ
 ╚ `/ungban user reason`*:* ᴜɴʙᴀɴꜱ ᴛʜᴇ ᴜꜱᴇʀ ꜰʀᴏᴍ ᴛʜᴇ ɢʟᴏʙᴀʟ ʙᴀɴꜱ ʟɪꜱᴛ
 ╔ *Module loading:*
