...
from KRISTY import StartTime, dispatcher
...
def ping(update: Update, context: CallbackContext):
    ...
    update.effective_message.reply_photo(
        ...
        "<b>ꜱᴇʀᴠɪᴄᴇ ᴜᴘᴛɪᴍᴇ:</b> <code>{}</code> \nʙᴀʙʏ🖤".format(telegram_ping, uptime),
...
def pingall(update: Update, context: CallbackContext):
    ...
    reply_msg = "⏱ᴘɪɴɢ ʀᴇꜱᴜʟᴛꜱ ᴀʀᴇ:\n"
    reply_msg += "\n".join(pinged_list)
    reply_msg += "\n<b>ꜱᴇʀᴠɪᴄᴇ ᴜᴘᴛɪᴍᴇ:</b> <code>{}</code>".format(uptime)
