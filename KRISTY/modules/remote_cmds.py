...
def runban(update: Update, context: CallbackContext):
    ...
    try:
        ...
        if excp.message == "User not found":
            message.reply_text("ɪ ᴄᴀɴ'ᴛ ꜱᴇᴇᴍ ᴛᴏ ꜰɪɴᴅ ᴛʜɪꜱ ᴜꜱᴇʀ ᴛʜᴇʀᴇ ʙᴀʙʏ🖤")
            return
        raise
    ...
    try:
        ...
        if excp.message == "Reply message not found":
            # Do not reply
            message.reply_text("ᴜɴʙᴀɴɴᴇᴅ!", quote=False)
...
def rmute(update: Update, context: CallbackContext):
    ...
    try:
        ...
        if excp.message == "Reply message not found":
            # Do not reply
            message.reply_text("ᴍᴜᴛᴇᴅ ʙᴀʙʏ🖤!", quote=False)
...
def runmute(update: Update, context: CallbackContext):
    ...
    if not args:
        message.reply_text("ʏᴏᴜ ᴅᴏɴ'ᴛ ꜱᴇᴇᴍ ᴛᴏ ʙᴇ ʀᴇꜰᴇʀʀɪɴɢ ᴛᴏ ᴀ ᴄʜᴀᴛ/user ʙᴀʙʏ🖤.")
        return
    ...
    if is_user_in_chat(chat, user_id):
        if (
            ...
            message.reply_text("ᴛʜɪꜱ ᴜꜱᴇʀ ᴀʟʀᴇᴀᴅʏ ʜᴀꜱ ᴛʜᴇ ʀɪɢʜᴛ ᴛᴏ ꜱᴘᴇᴀᴋ ɪɴ ᴛʜᴀᴛ ᴄʜᴀᴛ ʙᴀʙʏ🖤.")
            return
